...
function addFormulario() {
    ...
    texto1.textContent = "Nombres - Automata 1";
    ...
    if (TipoDato === 'AFD') {
        while (a <= numero) {
            ...
            div.innerHTML = '<div style="clear:both" class=" "' + a + ' col-md-offset-1 col-md-6"><input id="a1valor' + count1 +
                '" class="form-control" style="margin-bottom: 5px;"  placeholder="Nombre estado ' + [a] + ' "  ' + a + '" type="text"/> <input type="radio" id="A1inicial' + count1 + '" name="inicia" required>Inicial <input type="checkbox" id="A1final' + count1 + '" name="final" required> Final</div>';
        ...
        texto2.textContent = "Nombres - Automata 2";
        let count2 = 1;
        let b = 1;
        ...
        while (b <= numero2) {
            ...
            div.innerHTML = '<div style="clear:both" class=" "' + b + ' col-md-offset-1 col-md-6"><input id="a2valor' + count2 +
                '" class="form-control" style="margin-bottom: 5px;"  placeholder="Nombre estado ' + [b] + ' " ' + b + '" type="text"/> <input type="radio" id="A2inicial' + count2 +
        ...
        texto3.textContent = "Alfabeto - Automata 1";

        var leEntrada = document.getElementById("nEntradas").value;
        console.log("Lenguaje Automata 1 :", leEntrada);
        var count = 1;
        var x = leEntrada;
        let k = 1;
        ...
        texto4.textContent = "Alfabeto - Automata 2 ";
        var leEntrada2 = document.getElementById("nEntradas2").value;
        console.log("Lenguaje Automata 2 :", leEntrada2);
        var count5 = 1;
        var p = leEntrada2;
        let m = 1;
...
function TablaTransicion(arrayConjunto, arraylenguaje, tablaTransicion1) {
    ...
    for (let i = 0; i < transiciones.length; i++) {
        ...
        colTitulo.style.backgroundColor = "#2f8fbb";
    ...
    for (let i = 0; i < arrayConjunto.length; i++) {
        for (let j = 0; j < arraylenguaje.length; j++) {
            ...
            filaDatos.style.backgroundColor = "#ffffff6c";
...
function primeraQuintupla() {
    ...
    output1.textContent = (`Conjunto Q de estados:  [${conjunto1}]:`);
    output2.textContent = (`Estado inicial:  [${entrada1}]`);
    output3.textContent = (`Conjunto de salidas - automata 1:  [${salida1}]`);
    output4.textContent = (`Alfabeto:  [${lenguaje}]:`);
    output5.textContent = (`Transicion 1:  [${transicion1}]:`);
    output6.textContent = (`Conjunto Q de estados:  [${conjunto2}]:`);
    output7.textContent = (`Estado inicial:  [${entrada2}]`);
    output8.textContent = (`Conjunto de salidas - automata 2:  [${salida2}]`);
    output9.textContent = (`Alfabeto:  [${lenguaje2}]:`);
    output10.textContent = (`Transicion 2:  [${transicion2}]:`);
...
function TablaTransicionVacia(arrayConjunto, arraylenguaje, tablaTransicion1) {
    ...
    for (let i = 0; i < transiciones.length; i++) {
        ...
        colTitulo.style.width = "100px";
        colTitulo.style.height = "30px";
        colTitulo.style.backgroundColor = "#ffffff6c";
        colTitulo.style.textAlign = "center";
    }
...
function Complemento() {
    ...
    if (TipoAuto5 === 'AFD') {
        ...
        console.log("Complementos Primer Automata - Entradas:", arrayEcomplementada);
        console.log("Complementos Primer Automata - Salidas:", arrayScomplementada);

        console.log("Complementos Segundo Automata - Entradas:", arrayEcomplementada2);
        console.log("Complementos Segundo Automata - Salidas:", arrayScomplementada2);
        ...
        output1.textContent = (`Complemento pasa por los iniciales y finales, y al reves.`);
        output1.style.className = "divider";
        output2.textContent = (`Complemento Automata 1`);
        output2.style.className = "py-3";
        output3.textContent = (`Conjunto automata 1 complemento:  [${conjunto1}]`);
        output3.style.className = "ml-3";
        output4.textContent = (`Estado inicial automata 1 complemento:  [${arrayEcomplementada}]`);
        output4.style.className = "ml-3";
        output5.textContent = (`Estados finales automata 1 complemento:  [${arrayScomplementada}]`);
        output5.style.className = "ml-3";
        output6.textContent = (`Lenguaje automata 1 complemento:  [${lenguaje1}]`);
        output6.style.className = "ml-3";
        output7.textContent = (`Transiciones automata 1 complemento:  [${transicionAutomata1}]`);
        output7.style.className = "ml-3";
        output8.textContent = (`Complemento Automata 2`);
        output8.style.className = "py-3";
        output9.textContent = (`Conjunto automata 2 complemento:  [${conjunto2}]`);
        output10.textContent = (`Estado inicial automata 2 complemento:  [${arrayEcomplementada2}]`);
        output11.textContent = (`Estados finales automata 2 complemento:  [${arrayScomplementada2}]`);
        output12.textContent = (`Lenguaje automata 2 complemento:  [${lenguaje2}]`);
        output13.textContent = (`Transiciones automata 2 complemento:  [${transicionAutomata2}]`);
    ...
    if (TipoAuto5 == 'AFD/AFND') {
        ...
        const output1 = document.querySelector("#mensajeComplemento");
        output1.textContent = "Complemento solo para Automatas AFD";
    }
...
function validador1() {
    ...
    for (let i = 0; i < arrayvali.length; i++) {
        ...
        for (let j = 0; j < transi.length; j++) {
            if (transi[j] === "" || transi[j] === " " || transi[j] === "  " || transi[j] === "   ") {
                window.alert("Llenar el/los destino/s faltantes en Automata 1.");
                return 0;
    ...
    if (contador !== transi.length) {
        window.alert("Hay un estado que no existe o puede haber un espacio/s extra/s, Reingresar opcion/es para Automata 1.");
        return 0;
    }
}
...
function validador2() {
    ...
    for (let i = 0; i < arrayvali.length; i++) {
        ...
        for (let j = 0; j < transi.length; j++) {
            if (transi[j] === "" || transi[j] === " " || transi[j] === "  " || transi[j] === "   ") {
                window.alert("Llenar el/los destino/s faltantes en Automata 2.");
                return 0;
            } else if (aux1 === transi[j]) {
                contador++;
            }
    ...
    if (contador !== transi.length) {
        window.alert("Hay un estado que no existe o puede haber un espacio/s extra/s, Reingresar opcion/es para Automata 2.");
        return 0;
    }
}
...
function confirmarTRA() {
    ...
    if (TipoDatos === 'AFD') {
        ...
        var aux6 = validador4();
        if (aux5 === 0) {
            window.alert("Llenado de los Automatas AFD/AFND se debe llenar el Automata 1 AFD y Automata 2 AFND, Reingresa tu/s opción/es en Automata 1.");
            return 0;

        } else if (aux6 === 0) {
            window.alert("Llenado de los Automatas AFD/AFND se debe llenar el Automata 1 AFD y Automata 2 AFND, Reingresa tu/s opción/es en Automata 2.");
            return 0;
        } else {
            llenarTransicion1();
            llenarTransicion2();
...
function union() {
    ...
    output1.textContent = (`Conjunto union de estados=  [${conjuntoUnion}]:`);
    output1.className = "mb-2 ml-3";
    output2.textContent = (`Estado inicial=  [${newEstados}]`);
    output2.className = "mb-2 ml-3";
    output3.textContent = (`Salidas Union automata 1=  [${unionSalidaas}]`);
    output3.className = "mb-2 ml-3";
    output4.textContent = (`Alfabeto=  [${lenguajeUnion}]:`);
    output4.className = "mb-2 ml-3";
    output5.textContent = (`Transicion de union=  [${transicionUnion}]:`);
...
function simplificar1() {
    ...
    output1.textContent = (`- Automata 1 simplificado`);
    output1.className = "my-4 ml-3 text-center";
    output2.textContent = (`Conjunto simplificado=  [${arrayResultado[0]}]:`);
    output2.className = "mb-2 ml-3";
    output3.textContent = (`Estado inicial=  [${entrada1}]`);
    output3.className = "mb-2 ml-3";
    output4.textContent = (`Salidas automata 1 simplificado=  [${salida1}]`);
    output4.className = "mb-2 ml-3";
    output5.textContent = (`Alfabeto=  [${arrayResultado[1]}]:`);
    output5.className = "mb-2 ml-3";
    output6.textContent = (`Transicion de simplificacion=  [${transicionFinal}]:`);
...
function simplificar2() {
    ...
    output1.textContent = (`- Automata 2 simplificado`);
    output1.className = "my-4 ml-3 text-center";
    output2.textContent = (`Conjunto simplificado =  [${arrayResultado[0]}]:`);
    output2.className = "mb-2 ml-3";
    output3.textContent = (`Estado inicial=  [${entrada2}]`);
    output3.className = "mb-2 ml-3";
    output4.textContent = (`Salidas automata 2 simplificado=  [${salida2}]`);
    output4.className = "mb-2 ml-3";
    output5.textContent = (`Alfabeto=  [${arrayResultado[1]}]:`);
    output5.className = "mb-2 ml-3";
    output6.textContent = (`Transicion de simplificacion=  [${transicionFinal[2]}]:`);
    output6.className = "mb-2 ml-3";
    return arrayResultado;
}
...
function imprimirSimplificar() {
    ...
    if (eltipo == 'AFD') {
        ...
        output2.textContent = "Los automatas son AFND, debes transformarlo a AFD, que se encuentra mas abajo.";
    } else if (eltipo == 'AFD/AFND') {
        var simplificarA1 = simplificar1();
        const output2 = document.querySelector("#mensajeSimpli1");
        output2.textContent = "El Automata 2 es AFND, debes transformarlo a AFD que se encuentra mas abajo.";
...
function concatenacion() {
    ...
    output1.textContent = (`Conjunto de concatenacion de estados=  [${arrayConjuntoConca}]:`);
    output1.className = "mb-2 ml-3";
    output2.textContent = (`Estado inicial=  [${entradaConca}]`);
    output2.className = "mb-2 ml-3";
    output3.textContent = (`Salida de concatenacion - automata 1=  [${salidaConca}]`);
    output3.className = "mb-2 ml-3";
    output4.textContent = (`Alfabeto=  [${lenguajesConca}]:`);
    output4.className = "mb-2 ml-3";
    output5.textContent = (`Transicion de concatenacion=  [${transicionConca}]:`);
    output5.className = "mb-2 ml-3";
...
function ChilevsPeru(arrayConjunto, entradaFun, salidasFun, lenguajeFun, transicionFun) {
    ...
    console.log("Transicion Antigua :", newTransicion);
    console.log("Nuevo ID :", idTra1);
    ...
    output1.textContent = (`Automata transformado a AFD: `);
    output1.className = "my-4 text-center";
    output2.textContent = (`Conjunto=  [${newConjunto}]:`);
    output2.className = "mb-2 ml-3";
    output3.textContent = (`Estado inicial=  [${entradaFun}]`);
    output3.className = "mb-2 ml-3";
    output4.textContent = (`Salidas automata 1=  [${salidasFun}]`);
    output4.className = "mb-2 ml-3";
    output5.textContent = (`Alfabeto=  [${newLenguaje}]:`);
    output5.className = "mb-2 ml-3";
    output6.textContent = (`Transicion=  [${array2}]:`);
    output6.className = "mb-2 ml-3";
...
function ChilevsPeru2(arrayConjunto, entradaFun, salidasFun, lenguajeFun, transicionFun) {
    ...
    console.log("Transicion Antigua :", newTransicion);
    console.log("Nuevo Conjunto :", newConjunto);
    console.log("TRANSICION FINAL :", transicionfinal);
    var array2 = [];
    ...
    output3.textContent = (`Estado inicial=  [${entradaFun}]`);
    output3.className = "mb-2 ml-3";
    output4.textContent = (`Salidas=  [${salidasFun}]`);
    output4.className = "mb-2 ml-3";
    output5.textContent = (`Alfabeto=  [${newLenguaje}]:`);
    output5.className = "mb-2 ml-3";
    output6.textContent = (`Transicion de la Interseccion=  [${array2}]:`);
    output6.className = "mb-2 ml-3";
...
function interseccion() {
    ...
    for (let t = 0; t < lengua1.length; t++) {
        if (lengua1[t] !== lengua2[t]) {
            var confirma = false;
            window.alert("Lenguajes incompatibles, Deben ser iguales para la interseccion.");
            return 0;
        } else {
            confirma = true;
        }
    ...
    console.log("Arreglo Transicion Final :", transicionFinal);
    ...
    output1.textContent = (`Automata transformado a AFD: `);
    output1.className = "my-4 ml-3 text-center";
    output2.textContent = (`Conjunto=  [${arrayCinter}]:`);
    output2.className = "mb-2 ml-3";
    output3.textContent = (`Estado inicial=  [${arrayEinter}]`);
    output3.className = "mb-2 ml-3";
    output4.textContent = (`Salidas=  [${arraySinter}]`);
    output4.className = "mb-2 ml-3";
    output5.textContent = (`Alfabeto=  [${lenguajeInter}]`);
    output5.className = "mb-2 ml-3";
    output6.textContent = (`Transicion de la Intersecion=  [${transicionFinal}]:`);
    output6.className = "mb-2 ml-3";
...
function convertirAFNDtoAFD() {
    ...
    if (TipoAutomata === 'AFD') {
        ...
        output1.textContent = "Ya son AFD.";
    ...
    } else if (TipoAutomata === 'AFND') {
        {
            ...
            console.log("Transicion Automata 1: ", array1);
            ...
            output1.textContent = (`Transformar automatas AFND a AFD`);
            output1.style.className = "mb-4";
            output2.textContent = (`AFND a AFD Automata 1`);
            output2.style.className = "py-3";
            output3.textContent = (`Conjunto= [${conjuntoAFND}]`);
            output3.style.className = "ml-3";
            output4.textContent = (`Estado inicial= [${entrada1}]`);
            output4.style.className = "ml-3";
            output5.textContent = (`Estados finales=  [${salida1}]`);
            output5.style.className = "ml-3";
            output6.textContent = (`Lenguaje=  [${lenguaje1}]`);
            output6.style.className = "ml-3";
            output7.textContent = (`Transiciones=  [${array1}]`);
            output7.style.className = "ml-3";

            output8.textContent = (`AFND a AFD del Automata 2`);
            output8.style.className = "py-3";
            output9.textContent = (`Conjunto=  [${conjuntoAFND2}]`);
            output10.textContent = (`Estado inicial=  [${entrada2}]`);
            output11.textContent = (`Estados finales=  [${salida2}]`);
            output12.textContent = (`Lenguaje= [${lenguaje2}]`);
            output13.textContent = (`Transiciones= [${array2}]`);
        ...
        var conjuntoAFND2 = conjunto2.unique();
        console.log("Conjunto Automata 2 :", conjuntoAFND2);
        var aux = llenarLEN();
        var idTra2 = TablaTransicionVacia(conjuntoAFND2, aux[1], tablaTransicion3);
        var array2 = [];
        var cont = 1;
        ...
        output2.textContent = "Automata 1 ya es AFD";
...
function simplificarAFND_AFD(conjuntoAFND, lenguaje1, Transicion1) {
    ...
    output1.textContent = (`Automata 1 simplicado: `);
    output1.className = "my-4 ml-3 text-center";
    output2.textContent = (`Conjunto simplificado=  [${arrayResultado[0]}]:`);
    output2.className = "mb-2 ml-3";
    output3.textContent = (`Estado inicial=  [${entrada1}]`);
    output3.className = "mb-2 ml-3";
    output4.textContent = (`Salidas de simplificacion=  [${salida1}]`);
    output4.className = "mb-2 ml-3";
    output5.textContent = (`Alfabeto=  [${arrayResultado[1]}]:`);
    output5.className = "mb-2 ml-3";
    output6.textContent = (`Transicion de simplificacion=  [${transicionFinal}]:`);
    output6.className = "mb-2 ml-3";
    console.log("RESULTADO FINAL :", arrayResultado);
    return arrayResultado;
}
...
function simplificarAFND_AFD1(conjuntoAFND, lenguaje1, Transicion1) {
    ...
    output3.textContent = (`Estado inicial=  [${entrada1}]`);
    output3.className = "mb-2 ml-3";
    output4.textContent = (`Aalidas de simplificacion=  [${salida1}]`);
    output4.className = "mb-2 ml-3";
    output5.textContent = (`Alfabeto=  [${arrayResultado[1]}]:`);
    output5.className = "mb-2 ml-3";
    output6.textContent = (`Transicion de simplificacion=  [${transicionFinal}]:`);
...
function Imprimir_AFND_AFD() {
    ...
    if (eltipo == 'AFD') {
        const output2 = document.querySelector("#mensajeConvertido");
        output2.textContent = "Automata 1 y 2 ya son AFD.";
